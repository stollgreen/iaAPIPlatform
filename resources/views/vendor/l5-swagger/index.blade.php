    ...
    @if(config('l5-swagger.defaults.ui.display.dark_mode'))
        <style>
            ...
            #dark-mode .swagger-ui{
                color: #e0e0e0; /* Helleres Weiß für bessere Lesbarkeit */
            }
            ...
            #dark-mode table thead tr th{
                ...
                color: #e0e0e0; /* Helle Schriftfarbe für Tabellenüberschriften */
            }
            #dark-mode .opblock .opblock-section-header{
            ...
            /* Neue Schriftfarben für bessere Lesbarkeit */
            #dark-mode h1, #dark-mode h2, #dark-mode h3, #dark-mode h4, #dark-mode h5 {
                color: #f0f0f0; /* Hellerer Ton für Überschriften */
            }

            #dark-mode a, #dark-mode .btn {
                color: #b5cce7; /* Helle Farbe für Links und Buttons */
            }

            #dark-mode a:hover, #dark-mode .btn:hover {
                color: #d4d4d4; /* Hover-Effekt für Links und Buttons */
            }
        </style>    @endif
</head>
