...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: "role", description: "Role assigned to the commitment", type: "string", example: "Promoter"),
        ...
        new OA\Property(property: "status", description: "Status of the commitment", type: "string", example: 1, nullable: false),
    ]
)]
class CommitmentStoreRequest extends FormRequest
{
    /**
