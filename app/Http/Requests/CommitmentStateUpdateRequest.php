...
/**
 * Handle the HTTP request for updating commitment states.
 *
 ...
 */
#[OA\Schema(
    schema: "CommitmentStateUpdateRequest",
    title: "CommitmentStateUpdateRequest",
    description: "CommitmentStateUpdateRequest",
    required: ["name"],
    properties: [
        new OA\Property(property: "name", description: "Name of the commitment state", type: "string"),
    ]
)]
class CommitmentStateUpdateRequest extends FormRequest
{
    /**
